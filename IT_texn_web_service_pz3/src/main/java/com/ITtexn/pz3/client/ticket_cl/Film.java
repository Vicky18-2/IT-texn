...
public class Film {
    ...
    public Film(String description12, String director, String filmDuration, com.ITtexn.pz3.client.ticket_cl.Genre genre, int idFilm, String language, String title) {
