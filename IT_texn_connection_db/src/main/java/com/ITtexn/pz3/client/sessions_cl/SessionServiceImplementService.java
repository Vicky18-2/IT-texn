 ...
 * 
 */
@WebServiceClient(name = "SessionServiceImplementService", targetNamespace = "http://session.service.pz3.ITtexn.com/", wsdlLocation = "http://localhost:7777/session?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SESSIONSERVICEIMPLEMENTSERVICE_QNAME = new QName("http://session.service.pz3.ITtexn.com/", "SessionServiceImplementService");
    ...
    public SessionService getSessionServiceImplementPort() {
        return super.getPort(new QName("http://session.service.pz3.ITtexn.com/", "SessionServiceImplementPort"), SessionService.class);
    }
    ...
    public SessionService getSessionServiceImplementPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://session.service.pz3.ITtexn.com/", "SessionServiceImplementPort"), SessionService.class, features);
    }
